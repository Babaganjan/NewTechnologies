...
// import { FeedbackMenu } from '@/widgets';
//
...
//       alternates: {
//         canonical: `${seoConfig.siteUrl}/products/turnstiles/${alias}`,
//       },
//       openGraph: {
//         title: productSEO.title,
//         description: productSEO.description,
//         url: `${seoConfig.siteUrl}/products/turnstiles/${alias}`,
//         images: [
//           {
...
// }
//
// export default async function TurnistilesPages({ params }: AliasPagesProps) {
//   const { alias } = await params;
//
//   const product = findProductBySlug(alias);
//
...
//     notFound();
//   }
//   const schemas = generateProductSchemaAuto(product);
//
//   return (
//     <>
