import type { ResultItem } from '@/shared/ui/types/Result.types';
...
export const resultData: ResultItem[] = [
    ...
    },
    {
      ...
      description: 'Платформы с простой интеграцией, модульной архитектурой и масштабируемостью под любые задачи.',
      variant: 'light',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description: 'От проектирования до монтажа. Надёжные решения под ключ с гарантией до 12 месяцев.',
      variant: 'light',
    },
    {
      id: 5,
      ...
      description: 'Возьмемся за проект любого масштаба: от частных владений до объектов национального значения.',
      variant: 'light',
