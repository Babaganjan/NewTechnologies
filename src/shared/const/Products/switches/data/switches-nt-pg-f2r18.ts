...
export const SWITCH_NT_PG_F2R18: ProductConfig = {
  ...
  gallery: {
    images: ['/img/switch-nt-pg-f2r18-image1.png', '/img/switch-nt-pg-f2r18-image2.png'],
  },
  ...
  dimensions: {
    images: ['/img/switch-nt-pg-f2r18-dimensions.jpg'],
  },
      ...
      data: [
        {
          ...
          item: [
            {
              title: 'PoE порты',
              subtitle: '16×10/100/1000Base-T Gigabit PoE портов',
            },
            {
              title: 'SFP порты',
              subtitle:
                '2 гигабитных интернет-порта SFP + 2 гигабитных верхних оптических порта SFP',
            },
          ],
        },
        {
