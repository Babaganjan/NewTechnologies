...
export const SWITCH_NT_PAG_F1R26: ProductConfig = {
  ...
  gallery: {
    images: ['/img/switch-nt-pag-f1r26-image1.png', '/img/switch-nt-pag-f1r26-image2.png'],
  },
  ...
  dimensions: {
    images: ['/img/switch-nt-pag-f1r26-dimensions.jpg'],
  },
      ...
      data: [
        {
          ...
          item: [
            {
              title: 'PoE порты',
              subtitle: '24×10/100Base-T PoE портов',
            },
            {
              title: 'Uplink порты',
